...
- `Question` / `QuestionBank` — load JSON, filter by (topic, subtopic) pair and difficulty, track which questions were used. `topic` is a snake_case identifier; `subtopic` is display text drawn verbatim on the board *(added 2026-08-31 — see `milestones/m3.md`)*
