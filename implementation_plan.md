...
| M7 | Settings, flow, and the graded bank — *added 2026-09-06, scope below; break-out doc when M6 closes.* A Settings screen with Difficulty presets and a board-size toggle; wizard back buttons, an in-game pause screen, and a click-to-continue on wrong answers; the question audit finished, every question difficulty-graded, and difficulty behavior wired to the chosen preset | 10–16 |
